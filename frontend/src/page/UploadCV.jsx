  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const evaluationResponse = await fetch(
        `${import.meta.env.VITE_API_URL}/api/candidates/evaluate`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="max-w-4xl rounded-xl bg-white p-8 shadow-sm">
        <h2 className="text-xl font-semibold text-gray-900">Candidate CV</h2>
          ...
          {evaluation && (
            <div className="mt-8">
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-5">
                {Object.entries(evaluation.evaluationMatrix || {}).map(
                  ([key, value]) => (
                    <div
                      key={key}
