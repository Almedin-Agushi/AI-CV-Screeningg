      ...
      <div className="w-full max-w-4xl rounded-xl bg-white p-4 shadow-sm sm:p-6 lg:p-8">
        ...
        <div className="mt-6 flex flex-col gap-4 md:flex-row">
          ...
          <input
            ...
            disabled={loading}
            className="w-full rounded-lg border border-gray-300 bg-gray-50 p-3 text-sm text-gray-700 outline-none focus:border-black disabled:cursor-not-allowed disabled:opacity-60"
          />
